  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="animate-fade-up inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-sol-yellow/30 bg-sol-yellow/5 mb-8">
        ...
        <div className="animate-fade-up animate-fade-up-d3 flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#events" className="px-8 py-4 bg-sol-yellow text-sol-black text-sm uppercase tracking-widest font-semibold rounded hover:bg-sol-gold transition-colors">See What&apos;s Playing</a>
          <a href="#drafts" className="px-8 py-4 border border-white/20 text-white text-sm uppercase tracking-widest font-semibold rounded hover:border-sol-yellow hover:text-sol-yellow transition-colors">View Draft List</a>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <svg className="w-5 h-5 text-sol-yellow/50" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>
      </div>
    </section>
  );
}
